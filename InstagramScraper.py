...
def InstAnalytics():
	...
	# Launch browser, make sure to have the chrome webdriver put in /usr/local/bin :)
	#also requires PhantomJS if using that as driver. Put that in the same place
	#amd Raspbian if running on rasberry pi
